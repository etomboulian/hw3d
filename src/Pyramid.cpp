    ...
    phi(adist(rng))
{
    ...
    if (!IsStaticInitialized())
    {
        ...
        model.verticies[0].color = { 255, 255, 0 };
        model.verticies[1].color = { 255, 255, 0 };
        model.verticies[2].color = { 255, 255, 0 };
        model.verticies[3].color = { 255, 255, 0 };
        model.verticies[4].color = { 255, 255, 80 };
        model.verticies[5].color = { 255, 10, 0 };
