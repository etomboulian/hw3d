...
std::optional<int> Window::ProcessMessages()
{
	...
	{
		// check for a quit message because peekmessage does not signal this via return
...
LRESULT WINAPI Window::HandleMsgSetup(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) noexcept
{
	...
	if (msg == WM_NCCREATE)
	{
		...
		// forward the message to the window class message handler
...
LRESULT Window::HandleMsg(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) noexcept
{
	...
	case WM_MOUSEMOVE:
	{
		...
		// if in client region then log move, and log enter + capture mouse 
		...
		// not in client -> log move / maintain capture if buttondown
		else
		{
...
Window::Exception::Exception(int line, const char* file, HRESULT hr) noexcept
	:ChiliException(line, file), hr(hr)						// hr = hResult (Windows default error type)
{
	// empty on purpose
}
